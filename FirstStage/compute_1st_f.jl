...
@everywhere begin
    using Optim, LinearAlgebra, Statistics, Distributions, CSV, DataFrames, Random, ForwardDiff, StatsBase, Clustering, JSON, Plots
    include("data_f_all.jl")
    include("em.jl")
end
...
# Read data
data_f = CSV.File(joinpath(data_path, "data_n_meas_f.csv")) |> DataFrame
...
#a = mean(data_f[:, Symbol("meas", 3)])
#b = mean(data_f[:, Symbol("meas", 6)])
#c = mean(data_f[:, Symbol("meas", 9)])
...
#θ_samples = draw_samples_positive_fast(k1_init, Δ1_init, k2_init, Δ2_init, k3_init, Δ3_init, k4_init, Δ4_init, κ_init, 5, data_f)
#θ_samples = draw_samples_positive_fast(k1_init, Δ1_init, k2_init, Δ2_init, κ_init, 5, data_f)
#cont = likelihood_cont(μ, α, σ, θ_samples, 5, data_f)
#cens = likelihood_cont(μ, α, σ, θ_samples, 5, data_f)
#posterior = expectation_step_n(k1_init, Δ1_init, k2_init, Δ2_init, k3_init, Δ3_init, k4_init, Δ4_init, κ_init, θ_samples, 5, data_f)
#m_step(posterior, θ_samples, 5, data_f)
#em_algorithm(k1_init, Δ1_init, k2_init, Δ2_init, k3_init, Δ3_init, k4_init, Δ4_init, κ_init, 1, data_f; max_iters=5000)
#em_algorithm(k1_init, Δ1_init, k2_init, Δ2_init, κ_init, μ, α, σ, 5, data_f; max_iters=1000)
#bootstrap_em(k1_init, Δ1_init, k2_init, Δ2_init, κ_init, μ, α, σ, 5, data_f, 100, 1000)

#μ = [mean(data_f[:, Symbol("meas", j)]) for j in 1:21]
#σ = [std(data_f[:, Symbol("meas", j)]) for j in 1:21]   # Calculate standard deviations for meas1 to meas9
#α = randn(Float64, size(μ)) * 0.1

#results1_f = bootstrap_estimate(k1_init, Δ1_init, k2_init, Δ2_init, k3_init, Δ3_init, k4_init, Δ4_init, κ_init, data_f, 100, 1000)
results1_f = bootstrap_estimate(k1_init, Δ1_init, k2_init, Δ2_init, κ_init, μ, α, σ, data_f, 100, 1000)
...
CSV.write("input_f.csv", df_dist_f)

# Replace 'file_path' with the actual path to your CSV file
file_path = "/Users/clairekim/Desktop/Project/Child Development/julia/input_f.csv"
...
final_estimates = results1_f["Final Estimates"]
...
results2_f = bootstrap_estimate(k1_init, Δ1_init, k2_init, Δ2_init, κ_init, μ, α, σ, data_f, 100, 5000)

# Extract estimated parameters into DataFrame
df_dist_f = DataFrame(Ψ_A_f = results2_f)

# Write the DataFrame to a CSV file
CSV.write("input_fin_f.csv", df_dist_f)

file_path = "/Users/clairekim/Desktop/Project/Child Development/julia/input_fin_f.csv"
...
θ_f = draw_samples_positive_one(k1, Δ1, k2, Δ2, κ, data_f)
snr_f = noise(α, σ, θ_f)
